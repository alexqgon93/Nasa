    ...
    <div class="exterior_1">
        ...
        <v-container>
            <form class="form_s">
                ...
                <v-text-field v-model="form.password" :type="show1 ? 'text' : 'password'" name="input-10-1" label="Password"></v-text-field>
                <v-checkbox label="I agree to NAEGSA's storage and processing of my personal data" v-model="form.accepted"></v-checkbox>
                <div class="en_but">
